...
exports.priceXchgErrors = exports.flexWalletErrors = exports.getAbiErrors = exports.abiError = void 0;
...
exports.flexWalletErrors = [
    ...
    abiError("message_sender_is_not_my_root", 102, "Message sender is not RootTokenContract address"),
    ...
    abiError("destroy_non_empty_wallet", 106, "Wallet with non-zero token balance can't be destroyed"),
