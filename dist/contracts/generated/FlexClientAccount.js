...
class FlexClientAccount extends appkit_1.Account {
    ...
    runCancelThemAll(input) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, helpers_1.runHelper)(this, "cancelThemAll", input);
        });
    }
    cancelThemAll(input) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    runContinueCancelThemAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, helpers_1.runHelper)(this, "continueCancelThemAll", {});
        });
    }
