...
export declare type WrapperDeployerTip31SetWrapperCodeInput = {
    code: string;
};
export declare type WrapperDeployerTip31SetFlexWalletCodeInput = {
    code: string;
};
export declare type WrapperDeployerTip31DeployInput = {
    _answer_id: number;
    init_args: string;
    wic_unsalted_code: string;
};
export declare type WrapperDeployerTip31DeployOutput = {
    first: string;
    second: string;
};
export declare type WrapperDeployerTip31GetArgsInput = {
    tip3cfg: {
        name: string;
        symbol: string;
        decimals: number;
...
export declare type WrapperDeployerTip31GetArgsOutput = {
    value0: string;
};
