    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield flex.evr.accounts.isActive(address))) {
            ...
            if (clientBalance < requiredBalance) {
                throw new error_1.FlexError(contracts_1.PRICE_XCHG_ERROR.not_enough_native_currency_to_process.exitCode, `Flex client ${address} balance ${clientBalance} is not enough to deploy trader. Required balance is ${requiredBalance}. You have to topup flex client balance.`);
            }
