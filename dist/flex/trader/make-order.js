...
function makeOrder(flex, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (BigInt(amount) < BigInt(pairDetails.min_amount)) {
            throw new error_1.FlexError(contracts_1.PRICE_XCHG_ERROR.amount_is_less_then_market_min_amount.exitCode, `Specified amount ${amount} is less then market min amount ${pairDetails.min_amount}`);
        }
