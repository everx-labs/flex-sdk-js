...
function cancelOrder(evr, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (findOrder(options.orderId, priceDetails.sells)) {
            ...
            throw new error_1.FlexError(contracts_1.PRICE_XCHG_ERROR.canceled.exitCode, `Order ${options.orderId} not found in price ${priceDetails.address}.`);
        }
...
function getPriceDetails(evr, client, pair, priceNum, price) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield evr.accounts.isActive(address))) {
            throw new error_1.FlexError(contracts_1.PRICE_XCHG_ERROR.incorrect_price.exitCode, `Orderbook's price account [${address}] does not exist. Please check that the price (${JSON.stringify(price)}) is correct.`);
        }
