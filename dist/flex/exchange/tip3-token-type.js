...
exports.addTip3TokenType = exports.TIP3_TOKEN_TYPE = void 0;
const contracts_1 = require("../../contracts");
const web3_1 = require("../web3");
exports.TIP3_TOKEN_TYPE = 0;
const DEFAULTS = {
...
function addTip3TokenType(web3, options) {
    var _a, _b, _c, _d, _e, _f, _g;
    return __awaiter(this, void 0, void 0, function* () {
        const deployer = yield web3.accounts.get(contracts_1.WrapperDeployerTip3Account, {
        ...
        yield deployer.deployContract({
            ...
            ext_wallet_value: (0, web3_1.toUnits)((_e = options.extWalletEvers) !== null && _e !== void 0 ? _e : DEFAULTS.extWalletEvers),
        });
        ...
        yield superRootOwner.runAddWrapperType({
            type: exports.TIP3_TOKEN_TYPE,
            main_evers: (0, web3_1.toUnits)((_f = options.mainEvers) !== null && _f !== void 0 ? _f : DEFAULTS.mainEvers),
            wrappers_cfg_keep_evers: (0, web3_1.toUnits)((_g = options.keepEvers) !== null && _g !== void 0 ? _g : DEFAULTS.keepEvers),
...
//# sourceMappingURL=tip3-token-type.js.map