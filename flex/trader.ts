...
export type MakeOrderOptions = {
     ...
     * If ommited library uses random generator. 
    */
...
export type OrderInfo = {
    /** Order ID. Unique for all the trader's orders.*/
    orderId: string,
    /** Trader ID */
    traderId: string,
    /** Price of Major token */
...
export type NewOrderInfo = {
     ...
     * If ommited in makeOrder parameters - randomly generated by the library
     */
    orderId: string,
