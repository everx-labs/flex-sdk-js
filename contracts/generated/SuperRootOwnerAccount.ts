...
export type SuperRootOwnerSetCodeInternalInput = {
    type: number /* uint8 */,
    code: string /* cell */,
};
...
export class SuperRootOwnerAccount extends Account {
    ...
    async deployContract(input: {
        ...
        builder?: string /* optional(address) */,
    }): Promise<{
    ...
    async runSetCodeInternal(input: SuperRootOwnerSetCodeInternalInput, options?: RunHelperOptions): Promise<RunHelperResult<void>> {
        return await runHelper(this, "setCodeInternal", input, options);
    }

    async setCodeInternal(input: SuperRootOwnerSetCodeInternalInput): Promise<RunLocalHelperResult<void>> {
        return await runLocalHelper(this, "setCodeInternal", input);
    }
