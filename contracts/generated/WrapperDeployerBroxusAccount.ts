...
export type WrapperDeployerBroxusSetWrapperCodeInput = {
    code: string /* cell */,
};

export type WrapperDeployerBroxusSetFlexWalletCodeInput = {
    code: string /* cell */,
};

export type WrapperDeployerBroxusDeployInput = {
    _answer_id: number /* uint32 */,
    init_args: string /* cell */,
    wic_unsalted_code: string /* cell */,
};

export type WrapperDeployerBroxusDeployOutput = {
    first: string /* address */,
    second: string /* uint256 */,
};

export type WrapperDeployerBroxusGetArgsInput = {
    tip3cfg: {
        name: string /* string */,
...
export type WrapperDeployerBroxusGetArgsOutput = {
    value0: string /* cell */,
};


export class WrapperDeployerBroxusAccount extends Account {
    ...
    constructor(
        ...
        super(WrapperDeployerBroxusAccount.package, options);
    ...
    async runSetWrapperCode(input: WrapperDeployerBroxusSetWrapperCodeInput): Promise<{
        transaction: Transaction,
    ...
    async setWrapperCode(input: WrapperDeployerBroxusSetWrapperCodeInput): Promise<{
        transaction: Transaction,
    }> {
        return await runLocalHelper(this, "setWrapperCode", input);
    }

    async runSetFlexWalletCode(input: WrapperDeployerBroxusSetFlexWalletCodeInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    }> {
    ...
    async setFlexWalletCode(input: WrapperDeployerBroxusSetFlexWalletCodeInput): Promise<{
        transaction: Transaction,
    }> {
        return await runLocalHelper(this, "setFlexWalletCode", input);
    }

    async runDeploy(input: WrapperDeployerBroxusDeployInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    ...
    async deploy_(input: WrapperDeployerBroxusDeployInput): Promise<{
        transaction: Transaction,
        output: WrapperDeployerBroxusDeployOutput,
    }> {
    ...
    async runGetArgs(input: WrapperDeployerBroxusGetArgsInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    ...
    async getArgs(input: WrapperDeployerBroxusGetArgsInput): Promise<{
        transaction: Transaction,
        output: WrapperDeployerBroxusGetArgsOutput,
    }> {
