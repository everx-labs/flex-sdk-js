...
export type WrapperBroxusDeployEmptyWalletOutput = {
    value0: string /* address */,
};

export type WrapperBroxusOnAcceptTokensTransferInput = {
...
export type WrapperBroxusBurnInput = {
...
export type WrapperBroxusTransferFromReserveWalletInput = {
    answer_addr?: string /* optional(address) */,
    to: string /* address */,
    tokens: string | number | bigint /* uint128 */,
};

export type WrapperBroxusRequestTotalGrantedInput = {
    _answer_id: number /* uint32 */,
};

export type WrapperBroxusRequestTotalGrantedOutput = {
    value0: string /* uint128 */,
};

export type WrapperBroxusClonedInput = {
    _answer_id: number /* uint32 */,
};

export type WrapperBroxusClonedOutput = {
    first?: string /* optional(address) */,
    second: string /* uint256 */,
};

export type WrapperBroxusSetClonedInput = {
...
export type WrapperBroxusGetDetailsOutput = {
    name: string /* string */,
...
export type WrapperBroxusGetTip3ConfigOutput = {
    name: string /* string */,
    symbol: string /* string */,
    decimals: number /* uint8 */,
    root_pubkey: string /* uint256 */,
...
export type WrapperBroxusHasInternalWalletCodeOutput = {
    value0: boolean /* bool */,
};

export type WrapperBroxusGetWalletAddressInput = {
    pubkey: string | number | bigint /* uint256 */,
    owner?: string /* optional(address) */,
};

export type WrapperBroxusGetWalletAddressOutput = {
    value0: string /* address */,
};

export type WrapperBroxusGetReserveWalletOutput = {
    value0: string /* address */,
};


export class WrapperBroxusAccount extends Account {
    ...
    constructor(
        ...
        super(WrapperBroxusAccount.package, options);
    ...
    async runInit(input: WrapperBroxusInitInput): Promise<{
        transaction: Transaction,
    ...
    async init(input: WrapperBroxusInitInput): Promise<{
        transaction: Transaction,
    }> {
        return await runLocalHelper(this, "init", input);
    }

    async runDeployEmptyWallet(input: WrapperBroxusDeployEmptyWalletInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    ...
    async deployEmptyWallet(input: WrapperBroxusDeployEmptyWalletInput): Promise<{
        transaction: Transaction,
        output: WrapperBroxusDeployEmptyWalletOutput,
    }> {
    ...
    async runOnAcceptTokensTransfer(input: WrapperBroxusOnAcceptTokensTransferInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    }> {
    ...
    async onAcceptTokensTransfer(input: WrapperBroxusOnAcceptTokensTransferInput): Promise<{
        transaction: Transaction,
    }> {
        return await runLocalHelper(this, "onAcceptTokensTransfer", input);
    }

    async runBurn(input: WrapperBroxusBurnInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    }> {
    ...
    async burn(input: WrapperBroxusBurnInput): Promise<{
        transaction: Transaction,
    }> {
        return await runLocalHelper(this, "burn", input);
    }

    async runTransferFromReserveWallet(input: WrapperBroxusTransferFromReserveWalletInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    }> {
    ...
    async transferFromReserveWallet(input: WrapperBroxusTransferFromReserveWalletInput): Promise<{
        transaction: Transaction,
    }> {
        return await runLocalHelper(this, "transferFromReserveWallet", input);
    }

    async runRequestTotalGranted(input: WrapperBroxusRequestTotalGrantedInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    ...
    async requestTotalGranted(input: WrapperBroxusRequestTotalGrantedInput): Promise<{
        transaction: Transaction,
        output: WrapperBroxusRequestTotalGrantedOutput,
    }> {
    ...
    async runCloned(input: WrapperBroxusClonedInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    ...
    async cloned(input: WrapperBroxusClonedInput): Promise<{
        transaction: Transaction,
        output: WrapperBroxusClonedOutput,
    }> {
    ...
    async runSetCloned(input: WrapperBroxusSetClonedInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    }> {
    ...
    async setCloned(input: WrapperBroxusSetClonedInput): Promise<{
        transaction: Transaction,
    }> {
    ...
    async runGetWalletAddress(input: WrapperBroxusGetWalletAddressInput): Promise<{
        transaction: Transaction,
        transactionTree: ResultOfQueryTransactionTree,
    ...
    async getWalletAddress(input: WrapperBroxusGetWalletAddressInput): Promise<{
        transaction: Transaction,
        output: WrapperBroxusGetWalletAddressOutput,
    }> {
