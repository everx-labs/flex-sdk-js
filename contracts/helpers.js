...
function errorWith(err, method, account, fn, params) {
    err.data = Object.assign(Object.assign({}, err.data), {
        [method]: {
...
function runHelper(account, fn, params) {
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ;(_b = account.log) === null || _b === void 0
            ? void 0
            : _b.processingStart(`Run ${account.constructor.name}.${fn}`)
        try {
            ...
            */
            ;(_c = account.log) === null || _c === void 0
                ? void 0
                : _c.info(` TX: ${result.transaction.id}`)
...
function deployHelper(account, fn, params) {
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ;(_b = account.log) === null || _b === void 0
            ? void 0
            : _b.processingStart(
                  `Deploy ${account.constructor.name}.${fn !== null && fn !== void 0 ? fn : ''}`,
              )
        try {
...
function runLocalHelper(account, fn, params) {
    ...
    return __awaiter(this, void 0, void 0, function*() {
        try {
            ;(_b = account.log) === null || _b === void 0
                ? void 0
                : _b.processingStart(`RunLocal ${account.constructor.name}.${fn}`)
